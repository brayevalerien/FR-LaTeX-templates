...
\definecolor{backgroundlight}{HTML}{414339}
...
% Pour utiliser un thème clair, utiliser la commande \uselighttheme.
% Les couleurs utilisées dans ce thème sont celles du thème Monokai Light.
% Thème par @zoxon sur github:
% https://github.com/zoxon/vscode-theme-monokai-light/

\newcommand{\uselighttheme}{
    \definecolor{background}{HTML}{fafafa}
    \definecolor{backgroundlight}{HTML}{414339} % TODO: change this to match light theme
    \definecolor{button}{HTML}{414339}
    \definecolor{textwhite}{HTML}{49483e}
    \definecolor{textgray}{HTML}{75715E}
    \definecolor{textred}{HTML}{f9005a}
    \definecolor{textgreen}{HTML}{679c00}
    \definecolor{textblue}{HTML}{0089b3}
    \definecolor{textmagenta}{HTML}{8c6bc8}
    \definecolor{textpurple}{HTML}{ae81ff}
}
...
\setbeamercolor{block body}{fg=textwhite, bg=backgroundlight}
\setbeamercolor{block title}{fg=background, bg=textwhite}
\setbeamercolor{bibliography item}{fg=textwhite}
\setbeamercolor{bibliography entry title}{fg=textwhite}
\setbeamercolor{bibliography entry location}{fg=textwhite}
\setbeamercolor{bibliography entry note}{fg=textwhite}
\setbeamercolor{bibliograph y entry author}{fg=textwhite}
